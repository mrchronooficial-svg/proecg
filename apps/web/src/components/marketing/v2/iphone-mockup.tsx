...
export function ECGTrace({ color = "#0066CC", className = "" }: { color?: string; className?: string }) {
  return (
    <svg viewBox="0 0 400 80" className={className} fill="none" stroke={color} strokeWidth={2.2} strokeLinecap="round" strokeLinejoin="round">
      <path d="M0 40 L40 40 L50 35 L60 40 L80 40 L88 25 L92 55 L96 10 L100 70 L104 40 L130 40 L140 30 L150 40 L180 40 L185 38 L195 42 L200 40 L240 40 L250 35 L260 40 L280 40 L288 25 L292 55 L296 10 L300 70 L304 40 L330 40 L340 30 L350 40 L400 40">
        <animate attributeName="stroke-dasharray" from="0 1600" to="1600 0" dur="3s" begin="0s" repeatCount="indefinite" />
      </path>
    </svg>
  );
}
