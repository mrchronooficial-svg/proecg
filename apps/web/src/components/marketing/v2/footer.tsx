      ...
      <div className="mx-auto max-w-7xl px-5 py-12 sm:px-6 sm:py-16 lg:py-20">
        <div className="grid grid-cols-1 gap-10 text-center md:grid-cols-5 md:gap-12 md:text-left">
          <div className="md:col-span-1">
            <div className="text-[20px] font-semibold tracking-tight">ProECG</div>
            <p className="mx-auto mt-3 max-w-xs text-[14px] leading-[1.6] text-white/55 md:mx-0 md:text-[13px]">
          ...
          {cols.map((c) => (
            <div key={c.title}>
              <div className="text-[14px] font-semibold tracking-tight text-white md:text-[13px]">{c.title}</div>
        ...
        <div className="mt-12 flex flex-col gap-2 border-t border-white/10 pt-6 text-center text-[12px] text-white/45 sm:mt-16 sm:pt-8 md:flex-row md:items-center md:justify-between md:gap-3 md:text-left">
