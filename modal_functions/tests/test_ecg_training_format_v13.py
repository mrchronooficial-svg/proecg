"""
v13: mais definicao que v12 (halo escuro) e mais fino que v8.

Nucleo skeleton preto + halo cinza escuro (~70) -> trace bem definido
mas ainda com 1 px de centro.
"""
...
logger = logging.getLogger("ecg_training_format_v13")
...
OUTPUT_DIR = RESULTS_ROOT / "ecg_training_format_v13"
...
HALO_GRAY = 70  # mais escuro que v12 (128) — mais definicao
...
def main() -> int:
    for stem in ECG_LIST:
        ...
        with cache_path.open("rb") as f:
            cache = pickle.load(f)
        img, new_w, new_h, n_skel, n_halo = make_v13(cache)
