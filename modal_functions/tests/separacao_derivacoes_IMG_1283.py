...
# ----- Paths -----
BASE = Path(r"C:\Users\rafae\Desktop\Projeto ECG\IMG_1283_pipeline_completo")
NORMALIZED_PATH = BASE / "00_normalized.png"
MASK_PATH = BASE / "05_canal_2_signal_PB.png"
OUTPUT_DIR = Path(r"C:\Users\rafae\Desktop\Projeto ECG\IMG_1283_separacao_ocr")
...
def build_leads_structure(bands: list[tuple], W: int, mask: np.ndarray,
                          ocr_dets: list[dict],
                          px_per_mm: float = 13.0) -> list[dict]:
...
def main() -> int:
    print("=" * 70)
    print("SEPARACAO DE DERIVACOES — IMG_1283")
    print("=" * 70)
    ...
    PX_PER_MM = 13.0  # do PixelSizeFinder, valor avg
    ...
    # Sumario txt
    sum_lines = [
        "Separacao de derivacoes IMG_1283",
        "=" * 60,
