    ...
    <section className="bg-white py-20 sm:py-32 lg:py-40">
      <div className="mx-auto max-w-7xl px-5 sm:px-6">
        <Reveal>
          ...
          <h2 className="mt-3 max-w-3xl text-[32px] font-semibold leading-[1.05] tracking-tight text-[#1d1d1f] sm:text-[48px] lg:text-[56px]">
            Segurança e privacidade desde o dia 1.
          </h2>
        </Reveal>

        <div className="mt-12 grid grid-cols-1 gap-4 sm:mt-16 sm:grid-cols-2 sm:gap-6 lg:mt-20 lg:grid-cols-4">
          {items.map((it, i) => (
            <Reveal key={it.title} delay={i * 0.06}>
              <div className="rounded-2xl border border-black/5 bg-[#fafafa] p-6 sm:p-8">
                <div className="inline-flex h-11 w-11 items-center justify-center rounded-xl bg-[#1d1d1f] text-white">
                  <it.icon className="h-5 w-5" />
                </div>
                <h3 className="mt-5 text-[17px] font-semibold tracking-tight text-[#1d1d1f] sm:text-[18px]">
                  {it.title}
                </h3>
                <p className="mt-2 text-[14px] leading-[1.55] text-[#1d1d1f]/65 sm:text-[14.5px]">
                  {it.body}
                </p>
              </div>
            </Reveal>
